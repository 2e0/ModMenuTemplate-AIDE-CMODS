...
public class Fps
{
    ...
    private void logFPS()
    {
        oneSecondLater = System.currentTimeMillis()+100;
        v_animator = ValueAnimator.ofFloat(0.0f, 0.5f);
	...
	public void updateWater() {
		...
		waterText.setText("FPS: " + Integer.toString(FPS));
	}
	...
	protected void init(Context context)
	{
		...
		waterText.setTextSize(12f);
		waterText.setTextColor(Color.GREEN);
		...
		grad.setColor(Color.parseColor("#0000FFFF"));
